...
#            return
    ...
    def createFrame(self):
        ...
        ##########################################
        ###### Select axis line
        selectAxisFrame = TK.Frame(self.frame)
        ...
        #
        self.newAxesMethod = []
        B = TK.Button(newAxesMethodLblFrame,text='New',command=lambda n=(0,self.newAxesMethod): self.bt_click(n))
        ...
        ##
        axis2twinLblFrame = TTK.LabelFrame(selectAxisFrame,text='Axis to twin')
        axis2twinLblFrame.grid_columnconfigure(0, weight=1)
        axis2twinLblFrame.grid_rowconfigure(0, weight=1)
        axis2twinLblFrame.grid(row=0, column=1,sticky='NSEW')
        #
        self.axis2TwinItem = []
        B = TK.Button(axis2twinLblFrame,text=self.axis_to_twin,command=lambda n=(0,self.axis2TwinItem): self.bt_click(n))
        self.axis2TwinItem.append(B)
        B.list = [i for i in xrange(len(self.subGraph.axis))]
        B.val = self.axis_to_twin
        B.var = ['axis_to_twin']
        B.treatmentId = 0 # 4 is float here
        B.grid(row=0,column=0,columnspan=1,sticky="nsew")
        ##
        #
        B = TK.Button(selectAxisFrame,text='Add new axis',command=self.cmd_addAxis)
        ...
        selectAxisLblFrame.grid(row=0, column=3, sticky='NSEW')
        #
        self.addAxisItem = []
        B = TK.Button(selectAxisLblFrame,text=self.ind_axis,command=lambda n=(0,self.addAxisItem): self.bt_click(n))
        ...
        CB = TK.Checkbutton(visibleframe,variable=var,command=lambda n=0: self.cb_visible(n))#, variable=var)
        CB.val = var
        ...
        CB = TK.Checkbutton(logframe,variable=var,command=lambda n=0: self.cb_logscale(n))#, variable=var)
        CB.val = var
        ...
        CB = TK.Checkbutton(autoscaleframe,variable=var,command=lambda n=0: self.cb_autoscale(n))#, variable=var)
        CB.val = var
        ...
        #
        self.positionItem = []
        B = TK.Button(xminframe,text=xmin,command=lambda n=(0,self.positionItem): self.bt_click(n))
        B.list = []
        B.val = xmin
        B.var = ['x','axis_min']
        ...
        #
        B = TK.Button(xmaxframe,text=xmax,command=lambda n=(1,self.positionItem): self.bt_click(n))
        B.list = []
        B.val = xmax
        B.var = ['x','axis_max']
        B.treatmentId = 4 # 4 is float here
        ...
        CB = TK.Checkbutton(invertedframe,variable=var,command=lambda n=0: self.cb_invertedAxis(n))#, variable=var)
        CB.val = var
        ...
        #
        self.labelItem = []
        B = TK.Button(labelframe,text=self.subGraph.axis_property[self.ind_axis].x.axis_label,command=lambda n=(0,self.labelItem): self.bt_click(n))
        B.list = []
        ...
        positionframe.grid(row=0,column=7,sticky='NESW')
        #
        positionframe.grid_columnconfigure(0,weight=1)
        positionframe.grid_rowconfigure(0,weight=1)
        #
        self.axisPositionItem=[]
        B = TK.Button(positionframe,text=position,command=lambda n=(0,self.axisPositionItem): self.bt_click(n))
        ...
        offsetframe.grid(row=0,column=8,sticky='NESW')
        #
        offsetframe.grid_columnconfigure(0,weight=1)
        offsetframe.grid_rowconfigure(0,weight=1)
        #
        B = TK.Button(offsetframe,text=offset,command=lambda n=(0,self.offsetItem): self.bt_click(n))
        B.list = []
        B.val = offset
        B.var = ['x','axis_offset']
        B.treatmentId = 4 # 4 is float here
        ...
        CB = TK.Checkbutton(visibleframe,variable=var,command=lambda n=1: self.cb_visible(n))#, variable=var)
        CB.val = var
        ...
        CB = TK.Checkbutton(logframe,variable=var,command=lambda n=1: self.cb_logscale(n))#, variable=var)
        CB.val = var
        ...
        CB = TK.Checkbutton(autoscaleframe,variable=var,command=lambda n=1: self.cb_autoscale(n))#, variable=var)
        CB.val = var
        ...
        #
        B = TK.Button(yminframe,text=ymin,command=lambda n=(2,self.positionItem): self.bt_click(n))
        B.list = []
        B.val = ymin
        B.var = ['y','axis_min']
        B.treatmentId = 4 # 4 is float here
        ...
        #
        B = TK.Button(ymaxframe,text=ymax,command=lambda n=(3,self.positionItem): self.bt_click(n))
        B.list = []
        B.val = ymax
        B.var = ['y','axis_max']
        B.treatmentId = 4 # 4 is float here
        ...
        CB = TK.Checkbutton(invertedframe,variable=var,command=lambda n=1: self.cb_invertedAxis(n))#, variable=var)
        CB.val = var
        ...
        labelframe.grid_rowconfigure(0,weight=1)
        #
        B = TK.Button(labelframe,text=self.subGraph.axis_property[self.ind_axis].y.axis_label,command=lambda n=(1,self.labelItem): self.bt_click(n))
        B.list = []
        ...
        positionframe.grid_rowconfigure(0,weight=1)
        #
        B = TK.Button(positionframe,text=position,command=lambda n=(1,self.axisPositionItem): self.bt_click(n))
        ...
        offsetframe.grid_rowconfigure(0,weight=1)
        #
        B = TK.Button(offsetframe,text=offset,command=lambda n=(1,self.offsetItem): self.bt_click(n))
        B.list = []
        B.val = offset
        B.var = ['y','axis_offset']
        B.treatmentId = 4 # 4 is float here
    ...
    def cmd_addAxis(self,event=None):
        ...
        if method_to_add == 'New':
            ...
            self.subGraph.addAxisTwinX(self.axis_to_twin)
        elif method_to_add == 'Twin Y':
            self.subGraph.addAxisTwinY(self.axis_to_twin)
        self.createFrame()
        # for others related window
        for w in [self.parent.editCurveWdw,self.parent.editGridWdw]:
            if w is not None:
                w.createFrame()
    # ----------------------------------------------------------- closeAllDialog
...
class editLegendWindow(TK.Toplevel):
    ...
    def createFrame(self):
        ...
        B = TK.Button(titleframe,text=self.subGraph.legend_property.legend_title,command=lambda n=(0,self.legend_title_textItem): self.bt_click(n))
        B.list = []
        ...
        #
        self.boldItem=[]
        B = TK.Button(boldframe,text='B',command=lambda n=(0,self.boldItem): self.bt_vaEtVient(n),font='bold')
        ...
        #
        self.italicItem=[]
        B = TK.Button(italicframe,text='I',command=lambda n=(0,self.italicItem): self.bt_vaEtVient(n),font='italic')
        B.grid(row=0,column=0,sticky='NSEW')
        B.nextVal = [1,0]
        ...
        B = TK.Button(sizeframe,text=self.subGraph.legend_property.legend_title_size,command=lambda n=(0,self.legend_title_sizeItem): self.bt_click(n))
        B.list = []
        ...
        boldframe.grid_rowconfigure(0,weight=1)
        #
        B = TK.Button(boldframe,text='B',command=lambda n=(1,self.boldItem): self.bt_vaEtVient(n),font='bold')
        B.grid(row=0,column=0,sticky='NSEW')
        B.nextVal = [1,0]
        B.list = ['normal','bold']
        ...
        italicframe.grid_rowconfigure(0,weight=1)
        #
        B = TK.Button(italicframe,text='I',command=lambda n=(1,self.italicItem): self.bt_vaEtVient(n),font='italic')
        B.grid(row=0,column=0,sticky='NSEW')
        B.nextVal = [1,0]
        B.list = ['normal','italic']
        ...
        sizeframe.grid_rowconfigure(0,weight=1)
        #
        B = TK.Button(sizeframe,text=self.subGraph.legend_property.legend_label_size,command=lambda n=(1,self.legend_title_sizeItem): self.bt_click(n))
        B.list = []
        ...
        B = TK.Button(sizeframe,text=self.subGraph.legend_property.legend_border_width,command=lambda n=(0,self.legend_border_widthItem): self.bt_click(n))
        B.list = []
        ...
        CB = TK.Checkbutton(displayFrame,variable=var,command=lambda n=0: self.cb_visibility(n))#, variable=var)
        CB.val = var
        ...
        B = TK.Button(sizeframe,text=self.subGraph.legend_property.legend_ncol,command=lambda n=(0,self.legend_ncolItem): self.bt_click(n))
        B.list = []
...
#
        ...
        #
        activeFrame = TK.LabelFrame(lblframe,text='Activate')
        ...
        CB = TK.Checkbutton(activeFrame,variable=var,command=lambda n=1: self.cb_visibility(n))#, variable=var)
        CB.val = var
        ...
        ########################################################
        ## Close
        B = TK.Button(self.frame,text='Close',command=self.cmd_close)
...
class editGraphWindow(TK.Toplevel):
    ...
    def createFrame(self):
        ...
        ### Row 0 -> SubPlotParams
        #
        SPPlblframe = TK.LabelFrame(self.frame,text="SubPlotParams")
        ...
        #
        SPPlblframe.grid(row=0,column=0,sticky='NSEW')
        self.subPlotParamsBtnItem = {}
        # --->Left
        lblframe = TK.LabelFrame(SPPlblframe,text="Left")
        lblframe.grid_columnconfigure(0,weight=1)
        lblframe.grid_rowconfigure(0,weight=1)
        lblframe.grid(row=0,column=0,sticky='NSEW')
        #
        B = TK.Button(lblframe,text=self.graphInstance.subPlotParams.left,command=lambda n=('left',self.subPlotParamsBtnItem): self.bt_click(n))
        B.list = []
        ...
        # --->Right
        lblframe = TK.LabelFrame(SPPlblframe,text="Right")
        lblframe.grid_columnconfigure(0,weight=1)
        lblframe.grid_rowconfigure(0,weight=1)
        lblframe.grid(row=0,column=1,sticky='NSEW')
        #
        B = TK.Button(lblframe,text=self.graphInstance.subPlotParams.right,command=lambda n=('right',self.subPlotParamsBtnItem): self.bt_click(n))
        B.list = []
        ...
        # --->Top
        lblframe = TK.LabelFrame(SPPlblframe,text="Top")
        lblframe.grid_columnconfigure(0,weight=1)
        lblframe.grid_rowconfigure(0,weight=1)
        lblframe.grid(row=0,column=2,sticky='NSEW')
        #
        B = TK.Button(lblframe,text=self.graphInstance.subPlotParams.top,command=lambda n=('top',self.subPlotParamsBtnItem): self.bt_click(n))
        B.list = []
        ...
        # --->Bottom
        lblframe = TK.LabelFrame(SPPlblframe,text="Bottom")
        lblframe.grid_columnconfigure(0,weight=1)
        lblframe.grid_rowconfigure(0,weight=1)
        lblframe.grid(row=0,column=3,sticky='NSEW')
        #
        B = TK.Button(lblframe,text=self.graphInstance.subPlotParams.bottom,command=lambda n=('bottom',self.subPlotParamsBtnItem): self.bt_click(n))
        B.list = []
        ...
        # --->H.Space
        lblframe = TK.LabelFrame(SPPlblframe,text="H.Space")
        lblframe.grid_columnconfigure(0,weight=1)
        lblframe.grid_rowconfigure(0,weight=1)
        lblframe.grid(row=0,column=4,sticky='NSEW')
        #
        B = TK.Button(lblframe,text=self.graphInstance.subPlotParams.hspace,command=lambda n=('hspace',self.subPlotParamsBtnItem): self.bt_click(n))
        B.list = []
        ...
        # --->W.Space
        lblframe = TK.LabelFrame(SPPlblframe,text="W.Space")
        lblframe.grid_columnconfigure(0,weight=1)
        lblframe.grid_rowconfigure(0,weight=1)
        lblframe.grid(row=0,column=5,sticky='NSEW')
        #
        B = TK.Button(lblframe,text=self.graphInstance.subPlotParams.wspace,command=lambda n=('wspace',self.subPlotParamsBtnItem): self.bt_click(n))
        B.list = []
        ...
        CBframe = TK.LabelFrame(self.frame,text="Active")
        CBframe.grid_rowconfigure(0,weight=1)
        CBframe.grid_columnconfigure(0,weight=1)
        CBframe.grid(row=0,column=1,sticky='NSEW')
        #
        #
        var = TK.IntVar()
        var.set(1)
        CB = TK.Checkbutton(CBframe,variable=var,command=lambda n=0: self.cb_active(n))#, variable=var)
        CB.val = var
        CB.var = 'active'
        CB.grid(row=0,column=0,sticky='NSEW')
        self.checkboxItem.append(CB)
        ...
        ## Row 1 -> Tight Layout
        #
        TLlblframe = TK.LabelFrame(self.frame,text="Tight Layout")
        ...
        #
        TLlblframe.grid(row=1,column=0,sticky='NSEW')
        #
        self.tightLayoutBtnItem = {}
        # --->Pad
        lblframe = TK.LabelFrame(TLlblframe,text="Pad")
        lblframe.grid_columnconfigure(0,weight=1)
        lblframe.grid_rowconfigure(0,weight=1)
        lblframe.grid(row=0,column=0,columnspan=2,sticky='NSEW')
        #
        B = TK.Button(lblframe,text=self.graphInstance.tightLayout.pad,command=lambda n=('pad',self.tightLayoutBtnItem): self.bt_click(n))
        B.list = []
        ...
        # --->H.Pad
        lblframe = TK.LabelFrame(TLlblframe,text="H.Pad")
        lblframe.grid_columnconfigure(0,weight=1)
        lblframe.grid_rowconfigure(0,weight=1)
        lblframe.grid(row=0,column=2,columnspan=2,sticky='NSEW')
        #
        B = TK.Button(lblframe,text=self.graphInstance.tightLayout.hpad,command=lambda n=('hpad',self.tightLayoutBtnItem): self.bt_click(n))
        B.list = []
        ...
        # --->W.Pad
        lblframe = TK.LabelFrame(TLlblframe,text="W.Pad")
        lblframe.grid_columnconfigure(0,weight=1)
        lblframe.grid_rowconfigure(0,weight=1)
        lblframe.grid(row=0,column=4,columnspan=2,sticky='NSEW')
        #
        B = TK.Button(lblframe,text=self.graphInstance.tightLayout.wpad,command=lambda n=('wpad',self.tightLayoutBtnItem): self.bt_click(n))
        B.list = []
        ...
        var = TK.IntVar()
        var.set(0)
        CB = TK.Checkbutton(CBframe,variable=var,command=lambda n=1: self.cb_active(n))#, variable=var)
        CB.val = var
        CB.var = 'active'
        CB.grid(row=0,column=0,sticky='NSEW')
        self.checkboxItem.append(CB)
        #
        ### Row 2 -> Size and Resolution
        #
        SaRlblframe = TK.LabelFrame(self.frame,text="Size & resolution")
        ...
        #
        SaRlblframe.grid(row=2,column=0,columnspan=2,sticky='NSEW')

        self.sizeItem={}
        # -> Fig.Size
        lblframe = TK.LabelFrame(SaRlblframe,text="Fig.Size (inches)")
        lblframe.grid_columnconfigure(0,weight=1)
        lblframe.grid_rowconfigure(0,weight=1)
        lblframe.grid(row=0,column=2,columnspan=1,sticky='NSEW')
        figsize = self.fig.get_size_inches()
        text = (int(figsize[0]),int(figsize[1]))
        B = TK.Button(lblframe,text=str(text),command=lambda n=('figsize',self.sizeItem): self.bt_click_pattern(n))
        B.val = str(text)
        B.var = 'figsize'
        ...
        # -> DPI
        lblframe = TK.LabelFrame(SaRlblframe,text="DPI (Dot Per Inch)")
        lblframe.grid_columnconfigure(0,weight=1)
        lblframe.grid_rowconfigure(0,weight=1)
        lblframe.grid(row=0,column=4,columnspan=1,sticky='NSEW')
        B = TK.Button(lblframe,text=self.fig.get_dpi(),command=lambda n=('dpi',self.sizeItem): self.bt_click_pattern(n))
        ...
        ### Row 3 -> Buttons
        #
        globalframe = TK.Frame(self.frame)
        ...
        globalframe.grid(row=3,column=0,columnspan=2,sticky='EW')
        # -> Set button
        B = TK.Button(globalframe,text="Configure",command=self.cmd_configure)
        B.grid(row=0,column=2,columnspan=1,sticky="nsew")
        # -> Close button
        B = TK.Button(globalframe,text="Close",command=self.cmd_close)
...
class editGridWindow(TK.Toplevel):
    ...
    def createFrame(self):
        ...
        #
        self.addAxisItem = []
        selectLblFrame = TK.LabelFrame(self.frame,text='Select Axis')
        ...
        B = TK.Button(selectLblFrame,text=self.ind_axis,command=lambda n=(0,self.addAxisItem): self.bt_click(n))
        self.addAxisItem.append(B)
        B.list = [i for i in xrange(len(self.subGraph.axis))]
        B.val = self.ind_axis
        B.var = 'axis'
        ...
        ########################################################
        ## Major grid
        lblframe = TK.LabelFrame(self.frame,text='Major grid')
        lblframe.grid(row=1,column=0,sticky="NSEW")
        #
        lblframe.grid_columnconfigure(0,weight=1)
        lblframe.grid_rowconfigure(0,weight=1)
        ...
        ### --> X axis
        ind = 0
        xlblframe = TK.LabelFrame(lblframe,text='X')
        ...
        ### ### ---> Display
        self.visibilityItem=[]
        displayFrame = TK.LabelFrame(xlblframe, text="Display")
        ...
        CB = TK.Checkbutton(displayFrame,variable=var,command=lambda n=ind: self.cb_visibility(n))#, variable=var)
        CB.val = var
        CB.var = 'display'
        CB.which=('major','x')
        CB.grid(row=0,column=0,sticky='NSEW')
...
#        ### ### ---> Grid color
        self.colorItem = []
        colorFrame = TK.LabelFrame(xlblframe, text="Color")
        ...
        ### ### ---> Grid width
        self.widthItem = []
        widthFrame = TK.LabelFrame(xlblframe, text="Width")
        ...
        #
        B = TK.Button(widthFrame,text=self.subGraph.grid_property[self.ind_axis].major.x.grid_width,command=lambda n=(ind,self.widthItem): self.bt_click(n))
        B.list = []
        ...
        ### ### ---> Grid style
        self.styleItem = []
        styleFrame = TK.LabelFrame(xlblframe, text="Style")
        ...
        #
        B = TK.Button(styleFrame,text=self.subGraph.grid_property[self.ind_axis].major.x.grid_style,command=lambda n=(ind,self.styleItem): self.bt_click(n))
        ...
        ### --> Y axis
        ind = 1
        ylblframe = TK.LabelFrame(lblframe,text='Y')
        ...
        ylblframe.grid_rowconfigure(0,weight=1)
        ### ### ---> Display
        displayFrame = TK.LabelFrame(ylblframe, text="Display")
        displayFrame.grid(row=0,column=0,sticky='NESW')
        #
        displayFrame.grid_columnconfigure(0,weight=1)
        displayFrame.grid_rowconfigure(0,weight=1)
        ...
        self.visibilityItem.append(CB)
        ### ### ---> Line color
        colorFrame = TK.LabelFrame(ylblframe, text="Color")
        colorFrame.grid(row=0,column=1,sticky='NESW')
        #
        colorFrame.grid_columnconfigure(0,weight=1)
        colorFrame.grid_rowconfigure(0,weight=1)
        ...
        self.colorItem.append(B)
        ### ### ---> Grid width
        widthFrame = TK.LabelFrame(ylblframe, text="Width")
        widthFrame.grid(row=0,column=2,sticky='NESW')
        #
        widthFrame.grid_columnconfigure(0,weight=1)
        widthFrame.grid_rowconfigure(0,weight=1)
        #
        B = TK.Button(widthFrame,text=self.subGraph.grid_property[self.ind_axis].major.y.grid_width,command=lambda n=(ind,self.widthItem): self.bt_click(n))
        B.list = []
        ...
        self.widthItem.append(B)
        ### ### ---> Grid style
        styleFrame = TK.LabelFrame(ylblframe, text="Style")
        styleFrame.grid(row=0,column=3,sticky='NESW')
        #
        styleFrame.grid_columnconfigure(0,weight=1)
        styleFrame.grid_rowconfigure(0,weight=1)
        #
        B = TK.Button(styleFrame,text=self.subGraph.grid_property[self.ind_axis].major.y.grid_style,command=lambda n=(ind,self.styleItem): self.bt_click(n))
        B.list = linestylelist
        ...
        ########################################################
        ## Minor grid
        lblframe = TK.LabelFrame(self.frame,text='Minor grid')
        lblframe.grid(row=2,column=0,sticky="NSEW")
        #
        lblframe.grid_columnconfigure(0,weight=1)
        lblframe.grid_rowconfigure(0,weight=1)
...
#        ### ### ---> Grid color
        ...
        widthFrame.grid_rowconfigure(0,weight=1)
        #
        B = TK.Button(widthFrame,text=self.subGraph.grid_property[self.ind_axis].minor.x.grid_width,command=lambda n=(ind,self.widthItem): self.bt_click(n))
        B.list = []
        ...
        styleFrame.grid_rowconfigure(0,weight=1)
        #
        B = TK.Button(styleFrame,text=self.subGraph.grid_property[self.ind_axis].minor.x.grid_style,command=lambda n=(ind,self.styleItem): self.bt_click(n))
        B.list = linestylelist
        ...
        widthFrame.grid_rowconfigure(0,weight=1)
        #
        B = TK.Button(widthFrame,text=self.subGraph.grid_property[self.ind_axis].minor.y.grid_width,command=lambda n=(ind,self.widthItem): self.bt_click(n))
        B.list = []
        ...
        styleFrame.grid_rowconfigure(0,weight=1)
        #
        B = TK.Button(styleFrame,text=self.subGraph.grid_property[self.ind_axis].minor.y.grid_style,command=lambda n=(ind,self.styleItem): self.bt_click(n))
        B.list = linestylelist
...
class input_dialogSelectZoneWindow(TK.Toplevel):
    ...
    def initialize(self,parent,B):
        ...
        ########################################################################
        # # # First line
        label = TK.LabelFrame(self,text='Filter zone(s)')
...
#        self.entry_filterSV.trace('w',lambda nm, idx, mode,var=self.marker_sampling_startSV: self.cmd_editStep(var,self.marker_sampling_start))
        ...
        lblframe = TK.LabelFrame(frame,text='Unused zone(s)')
        ...
        Button = TK.Button(frame,text='>>',command=self.cmd_addAll)
        Button.grid(row=0,column=1,sticky='NSEW')
        # # # Second line -> second column : Second button
        Button = TK.Button(frame,text='>',command=self.cmd_addSelection)
        Button.grid(row=1,column=1,sticky='NSEW')
        # # # Second line -> second column : Third button
        Button = TK.Button(frame,text='<',command=self.cmd_removeSelection)
        Button.grid(row=2,column=1,sticky='NSEW')
        # # # Second line -> second column : First button
        Button = TK.Button(frame,text='<<',command=self.cmd_removeAll)
        Button.grid(row=3,column=1,sticky='NSEW')

        # # # Second line -> third column
        lblframe = TK.LabelFrame(frame,text='Zone(s) to plot')
        ...
        frame.grid_rowconfigure(0,weight=1)
        #
        Button = TK.Button(frame,text='OK',command=self.cmd_selectZones)
        Button.grid(row=0,column=0,sticky='NSEW')
        #
        Button = TK.Button(frame,text='Close',command=self.cmd_close)
        Button.grid(row=0,column=1,sticky='NSEW')
...
class inputPattern_dialogWindow(TK.Toplevel):
    ...
    def initialize(self,parent,B):
        ...
        #
        lblframe = TK.LabelFrame(self,text='Enter value')
        lblframe.grid(row=0,column=0,sticky='NSEW')
        lblframe.grid_columnconfigure(0,weight=1)
        lblframe.grid_rowconfigure(0,weight=1)
        #
        ...
        Button = TK.Button(frame,text='OK',command=self.cmd_okButton)
        Button.grid(row=0,column=0,sticky='NSEW')

        Button = TK.Button(frame,text='Cancel',command=self.cmd_close)
        Button.grid(row=0,column=1,sticky='NSEW')
        #
...
class list_dialogWindow(TK.Toplevel):
    ...
    def initialize(self,parent,B):
        ...
        self.grid_rowconfigure(1,weight=1)
        #
        filterframe = TK.LabelFrame(self,text='Filter values')
        ...
        re_filter = re.compile(self.entry_filterSV.get())
        #
        self.lblframe = TK.LabelFrame(self,text='Select value')
...
class GraphTK(TK.Toplevel):
    ...
    def initialize(self):
        ...
        # Figure
        self.fig = MatplotlibFigure(self.parent,self.conf,self.dpi,self.figsize)
...
#        toolbar = NavigationToolbar2TkAgg(self.canvas,toolbar_frame)
    ...
    # ------------------------------------------------------------------ addAxis
    def addAxis(self,iCurSubGraph,shared=None,axis=0):
        axis_to_twin = axis
        if shared is None:
            self.fig.subGraph[iCurSubGraph].addAxis()
            return (len(self.fig.subGraph[iCurSubGraph].axis)-1)
    ...
    # -------------------------------------------------------------------- write
    def write(self,ind):
        line = '''graph_%s=GraphTK(obj,'%s','%s',dpi=%s,figsize=%s)'''%(ind,self.name,self.conf,self.dpi,self.figsize)
        return line
    # ------------------------------------------------------------ clickOnCanvas
...
#            return
    ...
    def createFrame(self):
        ...
        #################### -> Level 1
        #&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& Selection
        lblframe = TK.LabelFrame(self.frame, text="Selected")
        ...
        #
        self.lblframelvl1.append(lblframe)
        #
        self.selectionItem=[]
        #
        for ind in xrange(len(self.subGraph.curves)):
            var = TK.IntVar()
            CB = TK.Checkbutton(lblframe,variable=var,command=lambda n=ind: self.cb_selection(n))#, variable=var)
            CB.val = var
            CB.ind=ind
            CB.var='selection'
            CB.grid(row=ind,column=0,sticky='NSEW')
            self.selectionItem.append(CB)
        # Curve to add
        ind = len(self.subGraph.curves)
        var = TK.IntVar()
        CB = TK.Checkbutton(lblframe,variable=var,command=lambda n=ind: self.cb_selection(n),state=TK.DISABLED)#, variable=var)
        CB.val = var
        CB.ind=ind
        CB.var='selection'
        CB.grid(row=ind,column=0,sticky='NSEW')
        ...
        #&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& Id
        lblframe = TK.LabelFrame(self.frame, text="Curve Id")
        ...
        self.IdItem.append(LBL)
        #&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& Zone
        lblframe = TK.LabelFrame(self.frame, text="Zone(s)")
        ...
        for ind in xrange(len(self.subGraph.curves)):
            ...
            B = TK.Button(lblframe,text=len(c.zone),command=lambda n=(ind,self.zoneItem): self.bt_click(n))
            B.val = c.zone
#            B.val = c.zoneList
            B.var = 'zone'
            B.ind = ind
            ...
            self.zoneItem.append(B)
        # Curve to add
        ind = len(self.subGraph.curves)
        B = TK.Button(lblframe,text=len(self.parent.data.keys()),command=lambda n=(ind,self.zoneItem): self.bt_click(n))
...
#        B.val = B.list
        ...
        self.zoneItem.append(B)
        #&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& VarX
        lblframe = TK.LabelFrame(self.frame, text="VarX")
        ...
        for ind in xrange(len(self.subGraph.curves)):
            c = self.subGraph.curves[ind]
            B = TK.Button(lblframe,text=c.varx,command=lambda n=(ind,self.varxItem): self.bt_click(n))
            B.ind = ind
            ...
            B.treatmentId = 0
            B.grid(row=ind,column=0,columnspan=1,sticky="nsew")
            self.varxItem.append(B)
        # Curve to add
        ind = len(self.subGraph.curves)
        B = TK.Button(lblframe,text=None,command=lambda n=(ind,self.varxItem): self.bt_click(n))
        B.ind = ind
        B.list = self.filterVarWithZone(B)
        if len(B.list)!=0:
        ...
        self.varxItem.append(B)
        #&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& VarY
        lblframe = TK.LabelFrame(self.frame, text="VarY")
        ...
        for ind in xrange(len(self.subGraph.curves)):
            c = self.subGraph.curves[ind]
            B = TK.Button(lblframe,text=c.vary,command=lambda n=(ind,self.varyItem): self.bt_click(n))
            B.ind = ind
            B.list = self.filterVarWithZone(B)
            B.val = c.vary
            B.var = 'vary'
            ...
            B.treatmentId = 0
            B.grid(row=ind,column=0,columnspan=1,sticky="nsew")
            self.varyItem.append(B)
        # Curve to add
        ind = len(self.subGraph.curves)
        B = TK.Button(lblframe,text=None,command=lambda n=(ind,self.varyItem): self.bt_click(n))
        B.ind = ind
        B.list = self.filterVarWithZone(B)
        if len(B.list)!=0:
            B.config(text=B.list[0])
        ...
        self.varyItem.append(B)
        #&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& Line color
        lblframe = TK.LabelFrame(self.frame, text="L.color")
        ...
        for ind in xrange(len(self.subGraph.curves)):
            c = self.subGraph.curves[ind]
            B = TK.Button(lblframe,command=lambda n=(ind,self.line_colorItem): self.bt_click(n))
            B.list = []
            B.val = c.line_color
            B.var = 'line_color'
            B.config(bg=B.val)
        ...
        self.line_colorItem.append(B)
        #&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& Line size
        lblframe = TK.LabelFrame(self.frame, text="L.size")
        ...
        for ind in xrange(len(self.subGraph.curves)):
            c = self.subGraph.curves[ind]
            B = TK.Button(lblframe,text=c.line_width,command=lambda n=(ind,self.line_widthItem): self.bt_click(n))
            ...
            B.treatmentId = 0
            B.grid(row=ind,column=0,columnspan=1,sticky="nsew")
            self.line_widthItem.append(B)
        # Curve to add
        ind = len(self.subGraph.curves)
        B = TK.Button(lblframe,text=default_values['Curve']['line_width'],command=lambda n=(ind,self.line_widthItem): self.bt_click(n))
        B.list = (np.arange(0.5,100,0.5)).tolist()
        ...
        self.line_widthItem.append(B)
        #&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& Line style
        lblframe = TK.LabelFrame(self.frame, text="L.style")
        ...
        for ind in xrange(len(self.subGraph.curves)):
            c = self.subGraph.curves[ind]
            B = TK.Button(lblframe,text=c.line_style,command=lambda n=(ind,self.line_styleItem): self.bt_click(n))
            B.list = linestylelist
            B.val = c.line_style
            B.var = 'line_style'
            B.ind = ind
            B.treatmentId = 0
            B.grid(row=ind,column=0,columnspan=1,sticky="nsew")
            self.line_styleItem.append(B)
        # Curve to add
        ind = len(self.subGraph.curves)
        B = TK.Button(lblframe,text=default_values['Curve']['line_style'],command=lambda n=(ind,self.line_styleItem): self.bt_click(n))
        B.list = linestylelist
        ...
        self.line_styleItem.append(B)
        #&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& Symbol Face color
        lblframe = TK.LabelFrame(self.frame, text="S.color")
        ...
        self.lblframelvl1.append(lblframe)
        #
        self.marker_face_colorItem = []
        for ind in xrange(len(self.subGraph.curves)):
            c = self.subGraph.curves[ind]
            B = TK.Button(lblframe,command=lambda n=(ind,self.marker_face_colorItem): self.bt_click(n))
            B.list = []
            ...
            B.treatmentId = 1
            B.grid(row=ind,column=0,columnspan=1,sticky="nsew")
            self.marker_face_colorItem.append(B)
        # Curve to add
        ind = len(self.subGraph.curves)
        B = TK.Button(lblframe,command=lambda n=(ind,self.marker_face_colorItem): self.bt_click(n))
        B.list = []
        ...
        self.marker_face_colorItem.append(B)
        #&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& Symbol Face size
        lblframe = TK.LabelFrame(self.frame, text="S.size")
        ...
        self.lblframelvl1.append(lblframe)
        #
        self.marker_sizeItem = []
        for ind in xrange(len(self.subGraph.curves)):
            c = self.subGraph.curves[ind]
            B = TK.Button(lblframe,text=c.marker_size,command=lambda n=(ind,self.marker_sizeItem): self.bt_click(n))
            B.list = (np.arange(0.5,100,0.5)).tolist()
            B.val = c.marker_size
            B.var = 'marker_size'
            B.ind = ind
            B.treatmentId = 0
            B.grid(row=ind,column=0,columnspan=1,sticky="nsew")
            self.marker_sizeItem.append(B)
        # Curve to add
        ind = len(self.subGraph.curves)
        B = TK.Button(lblframe,text=default_values['Curve']['marker_size'],command=lambda n=(ind,self.marker_sizeItem): self.bt_click(n))
        B.list = (np.arange(0.5,100,0.5)).tolist()
        ...
        self.marker_sizeItem.append(B)
        #&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& Symbol Type
        lblframe = TK.LabelFrame(self.frame, text="S.type")
        ...
        self.lblframelvl1.append(lblframe)
        #
        self.marker_styleItem = []
        for ind in xrange(len(self.subGraph.curves)):
            c = self.subGraph.curves[ind]
            B = TK.Button(lblframe,text=c.marker_style,command=lambda n=(ind,self.marker_styleItem): self.bt_click(n))
            B.list = markername
            ...
            B.treatmentId = 0
            B.grid(row=ind,column=0,columnspan=1,sticky="nsew")
            self.marker_styleItem.append(B)
        # Curve to add
        ind = len(self.subGraph.curves)
        B = TK.Button(lblframe,text=default_values['Curve']['marker_style'],command=lambda n=(ind,self.marker_styleItem): self.bt_click(n))
        B.list = markername
        ...
        self.marker_styleItem.append(B)
        #&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& Symbol edge color
        lblframe = TK.LabelFrame(self.frame, text="S.edge color")
        ...
        self.lblframelvl1.append(lblframe)
        #
        self.marker_edge_colorItem = []
        for ind in xrange(len(self.subGraph.curves)):
            c = self.subGraph.curves[ind]
            B = TK.Button(lblframe,command=lambda n=(ind,self.marker_edge_colorItem): self.bt_click(n))
            B.list = []
            ...
            B.treatmentId = 1
            B.grid(row=ind,column=0,columnspan=1,sticky="nsew")
            self.marker_edge_colorItem.append(B)
        # Curve to add
        ind = len(self.subGraph.curves)
        B = TK.Button(lblframe,command=lambda n=(ind,self.marker_edge_colorItem): self.bt_click(n))
        B.list = []
        ...
        self.marker_edge_colorItem.append(B)
        #&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& Symbol edge size
        lblframe = TK.LabelFrame(self.frame, text="S.edge size")
        ...
        self.lblframelvl1.append(lblframe)
        #
        self.marker_edge_widthItem = []
        for ind in xrange(len(self.subGraph.curves)):
            c = self.subGraph.curves[ind]
            B = TK.Button(lblframe,text=c.marker_edge_width,command=lambda n=(ind,self.marker_edge_widthItem): self.bt_click(n))
            B.list = (np.arange(0.5,100,0.5)).tolist()
            ...
            B.treatmentId = 0
            B.grid(row=ind,column=0,columnspan=1,sticky="nsew")
            self.marker_edge_widthItem.append(B)
        # Curve to add
        ind = len(self.subGraph.curves)
        B = TK.Button(lblframe,text=default_values['Curve']['marker_edge_width'],command=lambda n=(ind,self.marker_edge_widthItem): self.bt_click(n))
        B.list = (np.arange(0.5,100,0.5)).tolist()
        ...
        lblframe = TK.LabelFrame(self.frame, text="Start")
        lblframe.grid(row=0,column=13,sticky='NESW')
        #
        lblframe.grid_columnconfigure(0,weight=1)
        for ind in xrange(len(self.subGraph.curves)+1):
            lblframe.grid_rowconfigure(ind,weight=1)
        ...
        self.lblframelvl1.append(lblframe)
        #
        self.marker_sampling_startItem = []
        for ind in xrange(len(self.subGraph.curves)):
            c = self.subGraph.curves[ind]
            B = TK.Button(lblframe,text=c.marker_sampling_start,command=lambda n=(ind,self.marker_sampling_startItem): self.bt_click(n))
            B.list = []
            ...
            B.treatmentId = 2
            B.grid(row=ind,column=0,columnspan=1,sticky="nsew")
            self.marker_sampling_startItem.append(B)
        # Curve to add
        ind = len(self.subGraph.curves)
        B = TK.Button(lblframe,text=default_values['Curve']['marker_sampling_start'],command=lambda n=(ind,self.marker_sampling_startItem): self.bt_click(n))
        B.list = []
        ...
        self.marker_sampling_startItem.append(B)
        #&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& Symbol sampling end
        lblframe = TK.LabelFrame(self.frame, text="End")
        lblframe.grid(row=0,column=14,sticky='NESW')
        #
        lblframe.grid_columnconfigure(0,weight=1)
        for ind in xrange(len(self.subGraph.curves)+1):
            lblframe.grid_rowconfigure(ind,weight=1)
        ...
        self.lblframelvl1.append(lblframe)
        #
        self.marker_sampling_endItem = []
        for ind in xrange(len(self.subGraph.curves)):
            c = self.subGraph.curves[ind]
            B = TK.Button(lblframe,text=c.marker_sampling_end,command=lambda n=(ind,self.marker_sampling_endItem): self.bt_click(n))
            B.list = []
            ...
            B.treatmentId = 2
            B.grid(row=ind,column=0,columnspan=1,sticky="nsew")
            self.marker_sampling_endItem.append(B)
        # Curve to add
        ind = len(self.subGraph.curves)
        B = TK.Button(lblframe,text=default_values['Curve']['marker_sampling_end'],command=lambda n=(ind,self.marker_sampling_endItem): self.bt_click(n))
        B.list = []
        ...
        lblframe = TK.LabelFrame(self.frame, text="Step")
        lblframe.grid(row=0,column=15,sticky='NESW')
        #
        lblframe.grid_columnconfigure(0,weight=1)
        for ind in xrange(len(self.subGraph.curves)+1):
            lblframe.grid_rowconfigure(ind,weight=1)
        ...
        self.lblframelvl1.append(lblframe)
        #
        self.marker_sampling_stepItem = []
        for ind in xrange(len(self.subGraph.curves)):
            c = self.subGraph.curves[ind]
            B = TK.Button(lblframe,text=c.marker_sampling_step,command=lambda n=(ind,self.marker_sampling_stepItem): self.bt_click(n))
            B.list = []
            ...
            B.treatmentId = 2
            B.grid(row=ind,column=0,columnspan=1,sticky="nsew")
            self.marker_sampling_stepItem.append(B)
        # Curve to add
        ind = len(self.subGraph.curves)
        B = TK.Button(lblframe,text=default_values['Curve']['marker_sampling_step'],command=lambda n=(ind,self.marker_sampling_stepItem): self.bt_click(n))
        B.list = []
        ...
        self.marker_sampling_stepItem.append(B)
        #&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& Legend label
        lblframe = TK.LabelFrame(self.frame, text="Legend label")
        lblframe.grid(row=0,column=16,sticky='NESW')
        #
        lblframe.grid_columnconfigure(0,weight=1)
        for ind in xrange(len(self.subGraph.curves)+1):
            lblframe.grid_rowconfigure(ind,weight=1)
        ...
        self.lblframelvl1.append(lblframe)
        #
        self.legend_labelItem = []
        for ind in xrange(len(self.subGraph.curves)):
            c = self.subGraph.curves[ind]
            B = TK.Button(lblframe,text=c.legend_label,command=lambda n=(ind,self.legend_labelItem): self.bt_click(n))
            B.list = []
            ...
            B.treatmentId = 3
            B.grid(row=ind,column=0,columnspan=1,sticky="nsew")
            self.legend_labelItem.append(B)
        # Curve to add
        ind = len(self.subGraph.curves)
        B = TK.Button(lblframe,text="...",command=lambda n=(ind,self.legend_labelItem): self.bt_click(n))
        B.list = []
        B.val = "..."
        B.var = 'legend_label'
        B.ind = ind
        ...
        self.legend_labelItem.append(B)
        #&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& Legend display
        lblframe = TK.LabelFrame(self.frame, text="Legend display")
        lblframe.grid(row=0,column=17,sticky='NESW')
        #
        lblframe.grid_columnconfigure(0,weight=1)
        for ind in xrange(len(self.subGraph.curves)+1):
            lblframe.grid_rowconfigure(ind,weight=1)
        ...
        self.lblframelvl1.append(lblframe)
        #
        self.legend_displayItem=[]
        #
        for ind in xrange(len(self.subGraph.curves)):
            var = TK.IntVar()
            var.set(1)
            CB = TK.Checkbutton(lblframe,variable=var,command=lambda n=ind: self.cb_legend_display(n))#, variable=var)
            CB.val = var
            CB.var = 'legend_display'
            CB.ind=ind
            CB.grid(row=ind,column=0,sticky='NSEW')
            self.legend_displayItem.append(CB)
        # Curve to add
        ind = len(self.subGraph.curves)
        var = TK.IntVar()
        var.set(1)
        CB = TK.Checkbutton(lblframe,variable=var,state=TK.DISABLED,command=lambda n=ind: self.cb_legend_display(n))#, variable=var)
        CB.val = var
        CB.var = 'legend_display'
        CB.ind=ind
        CB.grid(row=ind,column=0,sticky='NSEW')
        self.legend_displayItem.append(CB)
        #&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& Axis to plot
        lblframe = TK.LabelFrame(self.frame, text="Axis")
        lblframe.grid(row=0,column=18,sticky='NESW')
        #
        lblframe.grid_columnconfigure(0,weight=1)
        for ind in xrange(len(self.subGraph.curves)+1):
            lblframe.grid_rowconfigure(ind,weight=1)
        ...
        for ind in xrange(len(self.subGraph.curves)):
            c = self.subGraph.curves[ind]
            B = TK.Button(lblframe,text=c.axis,command=lambda n=(ind,self.axisItem): self.bt_click(n))
            B.list = [i for i in xrange(len(self.subGraph.axis))]
            B.val = c.axis
            B.var = 'axis'
            B.ind = ind
            B.treatmentId = 0
            B.grid(row=ind,column=0,columnspan=1,sticky="nsew")
            self.axisItem.append(B)
        # Curve to add
        ind = len(self.subGraph.curves)
        B = TK.Button(lblframe,text=0,command=lambda n=(ind,self.axisItem): self.bt_click(n))
        B.list = [i for i in xrange(len(self.subGraph.axis))]
        indexNone = 0
        B.val = 0
        B.var = 'axis'
        ...
        self.axisItem.append(B)
        #&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& Visibility
        lblframe = TK.LabelFrame(self.frame, text="Visibility")
        lblframe.grid(row=0,column=19,sticky='NESW')
        #
        lblframe.grid_columnconfigure(0,weight=1)
        for ind in xrange(len(self.subGraph.curves)+1):
            lblframe.grid_rowconfigure(ind,weight=1)
        ...
        for ind in xrange(len(self.subGraph.curves)):
            var = TK.IntVar()
            var.set(1)
            CB = TK.Checkbutton(lblframe,variable=var,command=lambda n=ind: self.cb_visibility(n))#, variable=var)
            CB.val = var
            CB.var = 'visible'
            CB.ind=ind
            CB.grid(row=ind,column=0,sticky='NSEW')
        ...
        var = TK.IntVar()
        var.set(1)
        CB = TK.Checkbutton(lblframe,variable=var,state=TK.DISABLED,command=lambda n=ind: self.cb_visibility(n))#, variable=var)
        CB.val = var
        CB.var = 'visible'
        CB.ind=ind
        CB.grid(row=ind,column=0,sticky='NSEW')
        ...
        #
        B = TK.Button(bottomFrame,text='Move Up',command=self.cmd_moveUp)
        B.grid(row=0,column=0,columnspan=1,sticky="nsew")
        #
        B = TK.Button(bottomFrame,text='Move Down',command=self.cmd_moveDown)
        B.grid(row=0,column=1,columnspan=1,sticky="nsew")
        #
        B = TK.Button(bottomFrame,text='Delete selected curves',command=self.cmd_rmCurves)
        B.grid(row=0,column=2,columnspan=1,sticky="nsew")
        #
        B = TK.Button(bottomFrame,text='Duplicate selected curves',command=self.cmd_duplicateCurves)
        B.grid(row=0,column=3,columnspan=1,sticky="nsew")
        #
        B = TK.Button(bottomFrame,text='Create curve to add',command=self.cmd_createCurve)
        B.grid(row=0,column=4,columnspan=1,sticky="nsew")
        #
        B = TK.Button(bottomFrame,text='Close',command=self.cmd_close)
    ...
    def cmd_moveUp(self,event=None):
        ...
        nbSelected = 0
        indSelected = None
        for ind in xrange(len(self.selectionItem)):
            select = self.selectionItem[ind]
            if select.val.get():
                nbSelected += 1
                indSelected = ind
    ...
    def cmd_moveDown(self,event=None):
        ...
        # Check if only a single curve has been selected
        if nbSelected != 1:
            tkMessageBox.showwarning('Move Down Failed','Need to select a single curve')
            return
        else:
            # if indSelected == len(self.selectionItem)-2, can not move down beacause it is already at the bottom !
            # Rmk : it is "-2" because there is the line for the "curve to add" that counts for one that is at the end
            if indSelected!= len(self.selectionItem)-2:
                c = cpy.deepcopy(self.subGraph.curves[indSelected])
                self.subGraph.curves[indSelected]=self.subGraph.curves[indSelected+1]
                self.subGraph.curves[indSelected+1]=c
                #
    ...
    def updateVarXYList(self,ind):
        self.varxItem[ind].list = self.filterVarWithZone(self.varxItem[ind])
        self.varyItem[ind].list = self.filterVarWithZone(self.varyItem[ind])
    # ----------------------------------------------------------- updateVarXYVal
    def updateVarXYVal(self,ind):
        needsUpdate = False
        if not self.varxItem[ind].val in self.varxItem[ind].list:
            self.varxItem[ind].val = None
            self.varxItem[ind].config(text='')
            needsUpdate = True
        if not self.varyItem[ind].val in self.varyItem[ind].list:
            self.varyItem[ind].val = None
            self.varyItem[ind].config(text='')
            needsUpdate = True
        if needsUpdate:
            try:
                self.subGraph.curves[ind].setValue(self.varxItem[ind].var,self.varxItem[ind].val)
                self.subGraph.curves[ind].setValue(self.varyItem[ind].var,self.varyItem[ind].val)
                # Update Graph
                self.parent.graphWdwL[self.graph].updateGraph(self.zone)
            except IndexError:
                return
    ...
    def filterVarWithZone(self,B):
        tmp = {}
        for zone in self.zoneItem[B.ind].val:
        ...
        #
        res = []
        nbzones = len(self.zoneItem[B.ind].val)
        for var in tmp.keys():
            if tmp[var]==nbzones:
                res.append(var)
        return sorted(res)
    ...
    def cmd_createCurve(self):
        ...
        ind = len(self.subGraph.curves)
        c= Curve(
        zone                   = self.zoneItem[ind].val,
        varx                   = self.varxItem[ind].val,
        vary                   = self.varyItem[ind].val,
        line_color             = self.line_colorItem[ind].val,
        line_style             = self.line_styleItem[ind].val,
        line_width             = self.line_widthItem[ind].val,
        marker_style           = self.marker_styleItem[ind].val,
        marker_size            = self.marker_sizeItem[ind].val,
        marker_edge_width      = self.marker_edge_widthItem[ind].val,
        marker_face_color      = self.marker_face_colorItem[ind].val,
        marker_edge_color      = self.marker_edge_colorItem[ind].val,
        marker_sampling_start  = self.marker_sampling_startItem[ind].val,
        marker_sampling_end    = self.marker_sampling_endItem[ind].val,
        marker_sampling_step   = self.marker_sampling_stepItem[ind].val,
        legend_label           = self.legend_labelItem[ind].val,
        legend_display         = True,
        visible                = True)
        # Add curves
    ...
    def cmd_duplicateCurves(self):
        for ind in xrange(len(self.selectionItem)):
            select = self.selectionItem[ind]
            if select.val.get():
                c = cpy.deepcopy(self.subGraph.curves[ind])
                self.subGraph.curves.append(c)
        self.reloadWindow()
        # Update Graph
        self.parent.graphWdwL[self.graph].updateGraph(self.zone)
                        ...
                        try:
                            ...
                            for var in Internal.getChildren(bcdata):
                                if Internal.getType(var) == 'DataArray_t':
                                    if not basename+'/'+zonename in self.data.keys():
                                        self.data[basename+'/'+zonename]={}
                                    self.data[basename+'/'+zonename][Internal.getName(var)+'_'+bcname]=Internal.getValue(var)
                        except IndexError:
                ...
                for flowsolution in Internal.getNodesFromType1(zone,'FlowSolution_t'):
                    ...
                    for var in Internal.getChildren(flowsolution):
                        if Internal.getType(var)=='DataArray_t':
                            if not basename+'/'+zonename in self.data.keys():
                                self.data[basename+'/'+zonename]={}
                            self.data[basename+'/'+zonename][Internal.getName(var)+'_'+flowsolutionname]=Internal.getValue(var)
    # ---------------------------------------------------------- addZoneWithDict
                        ...
                        try:
                            ...
                            for var in Internal.getChildren(bcdata):
                                if Internal.getType(var) == 'DataArray_t':
                                    if not basename+'/'+zonename in tmp.keys():
                                        tmp[basename+'/'+zonename]={}
                                    tmp[basename+'/'+zonename][Internal.getName(var)+'_'+bcname]=Internal.getValue(var)
                        except IndexError:
                            print '''bcdata = Internal.getNodesFromType(zoneBC,'BCData_t')[0] ------> Can not be loaded'''
                            pass
                ...
                for flowsolution in Internal.getNodesFromType1(zone,'FlowSolution_t'):
                    ...
                    for var in Internal.getChildren(flowsolution):
                        if Internal.getType(var)=='DataArray_t':
                            if not basename+'/'+zonename in tmp.keys():
                                tmp[basename+'/'+zonename]={}
                            tmp[basename+'/'+zonename][Internal.getName(var)+'_'+flowsolutionname]=Internal.getValue(var)
...
#        lblframe = TK.LabelFrame(lblframeCreate,text="Resolution")
    ...
    def selectPositionByName(self,name):
        ...
        for w in [self.editCurveWdw,self.editGridWdw,self.editLegendWdw,self.editAxisWdw]:
            if w is not None:
                w.initialize(self)
            if w is not None:
                w.reloadWindow()
...
#                    break
    ...
    def cmd_confSave(self):
        filename = tkFileDialog.asksaveasfilename(parent=self,initialdir=os.getcwd()) # Works only with python 2, for python 3, it seems that the module name has changed to "filedialog"
    ...
    def cmd_confLoad(self):
        filename = tkFileDialog.askopenfilename(parent=self,initialdir=os.getcwd())# Works only with python 2, for python 3, it seems that the module name has changed to "filedialog"
        if filename=='' or filename==None:
            return
...
#        spec.loader.exec_module(foo)
    ...
    def cmd_addGraph(self):
        if self.entryResolution.get() == 'default':
            dpi = None
        else:
            dpi = int(self.entryResolution.get())
        #
...
class MatplotlibFigure():
    def __init__(self,parent,conf,dpi=None,figsize=None):
        # Root window
        self.parent=parent
        # dpi, figsize
        self.dpi = dpi
...
#            self.subGraph[iCurSubGraph].axis[iCurrentAxis].set_ylabel(r'%s'%self.subGraph[iCurSubGraph].axis_property[iCurrentAxis].y.axis_label)
            ...
            self.subGraph[iCurSubGraph].axis[iCurrentAxis].patch.set_visible(False)
...
# ==============================================================================
class DirAxis():
    def __init__(self,axis_logscale,axis_autoscale,axis_min,axis_max,axis_label,axis_inverted,axis_visible,axis_position,axis_offset):
    ...
    def setValue(self,var,val):
        if var == 'axis_logscale':
            self.axis_logscale = val
        elif var == 'axis_autoscale':
            self.axis_autoscale = val
        elif var == 'axis_min':
            self.axis_min = val
        elif var == 'axis_max':
            self.axis_max = val
            ...
            self.axis_label = val
        elif var == 'axis_inverted':
            self.axis_inverted = val
        elif var == 'axis_visible':
            self.axis_visible = val
        elif var == 'axis_position':
            self.axis_position = val
        elif var == 'axis_offset':
            self.axis_offset = val
# ==============================================================================
# ==============================================================================
class Axis():
    def __init__(self,
...
# ==============================================================================
class AxisGrid:
    def __init__(self,display,grid_color,grid_style,grid_width):
...
# ==============================================================================
class LevelGrid():
    def __init__(self,x_display,x_grid_color,x_grid_style,x_grid_width,y_display,y_grid_color,y_grid_style,y_grid_width):
        self.x = AxisGrid(x_display,x_grid_color,x_grid_style,x_grid_width)
        self.y = AxisGrid(y_display,y_grid_color,y_grid_style,y_grid_width)
    def setValue(self,direction,var,val):
        if direction == 'x':
            self.x.setValue(var,val)
        else:
            self.y.setValue(var,val)
...
class Curve:
    ...
    def __init__(self,
                ...
                axis                          = default_values['Curve']['axis'],
    ...
    def setValue(self,var,val):
        if   var == 'zone':
            ...
            self.line_width = val
        elif var =='marker_style':
            self.marker_style = val
        elif var =='marker_size':
            self.marker_size = val
        elif var =='marker_edge_width':
            self.marker_edge_width = val
        elif var =='marker_face_color':
            self.marker_face_color = val
        elif var =='marker_edge_color':
            self.marker_edge_color = val
        elif var =='marker_sampling_start':
            self.marker_sampling_start = val
        elif var =='marker_sampling_end':
            self.marker_sampling_end = val
        elif var =='marker_sampling_step':
            self.marker_sampling_step = val
        elif var =='legend_label':
            self.legend_label = val
        elif var =='legend_display':
            self.legend_display = val
        elif var =='axis':
            self.axis = val
        elif var =='visible':
            self.visible = val
    # -------------------------------------------------------------------- write
    def write(self,indgraph,iCurSubGraph,indcurve):
        ...
        if self.axis                  != default_values['Curve']['axis']    :
            lines += ''', axis=%s'''%(self.axis)
...
class SubGraph:
    ...
    def addAxisTwinX(self,axis_to_twin):
        ...
        self.axis_property.append(Axis())
        self.axis_property[-1].name = self.name
...
def main(data):
    print '''Running the Cassiopee interface development incubator'''
...
def updateFromTree(event=None):
    if CTK.__MAINTREE__ == 1:
        ...
        tp = C.newPyTree(['Slice',1])
        zones = Internal.getZones(CTK.dt)
    # Get only 1D zones
    zin = []
    for z in zones:
