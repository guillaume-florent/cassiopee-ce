...
faces,d = C.nearestElements(hook,b)
ret = d.sum()
if ret != 0.: print 'nearestElements/faces (structured) FAILED: FPU is not correct [STRUCT/FACES]. Check compilation options.'
...
faces,d = C.nearestElements(hook,b)
ret = d.sum()
if ret != 0.: print 'nearestElements (EB) FAILED: FPU is not correct [STRUCT/FACES]. Check compilation options.'
# NGON
...
faces,d = C.nearestElements(hook,b)
ret = d.sum()
if ret != 0.: print 'nearestElements (NGon) FAILED: FPU is not correct [STRUCT/FACES]. Check compilation options.'
print 'done.'
