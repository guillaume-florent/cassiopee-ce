...
r"""Chimera assembly of 2 overlapping cylinders and a background Cartesian grid

This tutorial demonstrates how to perform Chimera assembly of a mesh composed
by two overlapping cylinders and a Cartesian background grid.

Chimera assembly by S. Péron.

First, a cellN variable is created. cellN will be equal to 1 for computed cells,
0 for blanked cells and 2 for interpolated cells.
To blank cells inside bodies defined by the two cylinders, we use the 
function X.blankCells of the Connector module.
To perform an overlap optimization, we use first the function X.applyBCOverlaps
to set the cellN to 2 to cells near overlap borders.
Then, functions X.optimizeOverlap and X.maximizeBlankedCells are applied
to optimize the overlapping between grids.
"""
...
# Cylinder 1
a = G.cylinder((0, 0, 0), 1, 10, 360, 0, 1, (200, 30, 2))
a[0] = 'cylindre1'
a = C.addBC2Zone(a, 'wall1', 'BCWall', 'jmin')
# Cylinder 2
b = G.cylinder((4, 0, 0), 1, 10, 360, 0, 1, (200, 30, 2))
b[0] = 'cylindre2'
