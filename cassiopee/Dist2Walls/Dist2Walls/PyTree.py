...
#==============================================================================
def eikonal(t,tc=None,loc='nodes',nitmax=10, err=0.01):
    """Solve the eikonal equation.
    Usage: eikonal(t,loc='nodes')"""
    tp = Internal.copyRef(t)
    _eikonal(tp,tc=tc,loc=loc, nitmax=nitmax, err=err)
    return tp
...
# In place version
#==============================================================================
def _eikonalForZone(z,loc='nodes'):
    """Solve the eikonal equation.
    ...
    nodes = Dist2Walls.eikonal(nodes)
...
#=============================================================================
def distance2WallsEikonal(t, body, tc=None, DEPTH=2, loc='nodes', err=0.01, nitmax=10, type=0):
    ...
    if loc == 'nodes':
        ...
        # Marquage des points 
        C._initVars(t,'Phi=%g*({flag}<1.)+({flag}>0.)'%PHIMAX)
    ...
    # Eikonal
    #print 'eikonal'
    _eikonal(t,tc,loc=loc, nitmax=nitmax, err=err)
