...
(const E_Float* point, const K_FLD::FloatArray& pos, const K_FLD::IntArray& connect, const K_FLD::IntArray& neighbors,
 const int_vector_type& ancestors, const bool_vector_type& mask, const tree_type& tree, OutputIterator out) const
{
  size_type         N0, K(E_IDX_NONE), b, count(0), Ni, Nj, Kneigh(E_IDX_NONE), A0;
  int_vector_type   anc;
  E_Float           q;
